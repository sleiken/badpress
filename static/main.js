...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {query: a, result: b, $class: c};
	});
var _user$project$Main$ResultRecord = F4(
	function (a, b, c, d) {
		return {p: a, n: b, s: c, t: d};
	});
var _user$project$Main$decode = A5(
	_elm_lang$core$Json_Decode$object4,
	_user$project$Main$ResultRecord,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'pos', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'neg', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'subjectivity', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'term', _elm_lang$core$Json_Decode$string));
			...
			case 'FetchSuccess':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							result: {p: _p1.p, n: _p1.n, s: _p1.s, t: _p1.t},
							$class: ''
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('h-align-center')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('v-align-center search-bar')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$html$Html_Attributes$placeholder('Enter a word or phrase to analyze'),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(_elm_lang$core$Basics_ops['++'], 'term ', model.$class))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(model.result.t)
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class(
								A2(_elm_lang$core$Basics_ops['++'], 'results ', model.$class))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											'Positive Tweets: ',
											A2(_elm_lang$core$Basics_ops['++'], model.result.p, '%')))
									])),
								A2(
								_elm_lang$html$Html$div,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('negativity')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text(
										A2(
											_elm_lang$core$Basics_ops['++'],
											'Negative Tweets: ',
											A2(_elm_lang$core$Basics_ops['++'], model.result.n, '%')))
									])),
								A2(
								_elm_lang$html$Html$div,
								_elm_lang$core$Native_List.fromArray(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											'Subjectivity Score: ',
											A2(_elm_lang$core$Basics_ops['++'], model.result.s, ' / 100')))
									]))
							]))
					]))
			]));
